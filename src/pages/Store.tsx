        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="impact-text text-5xl md:text-7xl text-[#209D50] mb-6">
              STORE<span className="text-[#E1DFD9]">.</span>
            </h1>
            <p className="text-black/70 text-lg max-w-2xl mx-auto">
              Our merchandise and fitness gear are currently being curated.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/80 rounded-3xl p-8 shadow-lg text-center">
              ...
              <p className="text-black/70 mb-8">
                We're curating high-quality calisthenics gear, apparel, and accessories 
                for the community. Sign up to be notified when our store launches.
              </p>
